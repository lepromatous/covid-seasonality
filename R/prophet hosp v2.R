...
ggsave(plot = trend.final, filename = "~/Desktop/hosp_trend.tiff", dpi = 300, height = 20, width = 30)
ggsave(plot = trend.final, filename = "~/Desktop/hosp_trend.pdf", dpi = 300, height = 20, width = 30)
...
ggsave(plot = week.final, filename = "~/Desktop/hosp_week.tiff", dpi = 300, height = 20, width = 30)
ggsave(plot = week.final, filename = "~/Desktop/hosp_week.pdf", dpi = 300, height = 20, width = 30)
...
ggsave(plot = reg.final, filename = "~/Desktop/hosp_reg.tiff", dpi = 300, height = 20, width = 30)
ggsave(plot = reg.final, filename = "~/Desktop/hosp_reg.pdf", dpi = 300, height = 20, width = 30)
