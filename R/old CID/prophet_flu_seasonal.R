...
prophet_seasonal_flu
ggsave("/Users/timothywiemken/Library/CloudStorage/OneDrive-Pfizer/Documents/Research/github/covid-seasonality/Manuscript/Lancet/Figures/prophet_US_seasonal_flu.pdf", width=10, height=6)
