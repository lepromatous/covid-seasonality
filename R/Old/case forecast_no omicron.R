...
save_plot("~/Desktop/prophet_no_omicron.pdf", p2, base_width=8, base_height=6)
#save_plot("~/Desktop/prophet_no_omicron.png", p2, base_width=8, base_height=6)
