...
ggplot(data = test) + 
  ...
  geom_ribbon(
    aes(x=ds, ymin =  yearly_lower, ymax=yearly_upper),
...
ggsave("/Users/timothywiemken/Library/CloudStorage/OneDrive-Pfizer/Documents/Research/github/COVID forecast/manuscript/JAMA/Figures/prophet_no_omicron_season.pdf", width=10, height=6)
